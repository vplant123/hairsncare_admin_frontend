...
const routesByRole = {
  ...
  subadmin: [
    { path: "/dashboard", label: "Dashboard", permissionKey: "dashboard" },
    ...
    { path: "/invoice", label: "Invoices", permissionKey: "invoices" },
...
const Sidebar = forwardRef<HTMLDivElement, SidebarProps>(
  ({ isMobileOpen = false, onMobileClose }, ref) => {
            ...
            {filteredRoutes.map(({ path, label }) => {
              ...
              return (
                ...
                >
                  ...
                  {!collapsed && (
                    <span
                      className={cn("ml-3 text-sm", active && "font-medium")}
                    >
                      {label}
                    </span>
                  )}
