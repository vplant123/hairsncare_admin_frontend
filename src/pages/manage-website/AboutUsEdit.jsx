...
export default function AboutUsEdit({
  ...
  const handleImageUploadSection3 = async (e, type, ind) => {
    if (type == "img") {
      ...
      console.log("nsjeorjte", inputData, e, type, ind);
  ...
  return (
    <>
          ...
          <div className="content-3">
            ...
            <div className="d-flex flex-column">
              {section3?.data?.map((step, ind) => {
                return (
                  <div key={`section3-step-${ind}`} className="content-item">
                    <div>
                      <input
                        type="text"
      ...
      <div className="about-container-3 ">
        <div className="container-3-item">
          ...
          <ReactQuill
            ...
            onChange={e => setSection4({ ...section4, desc: e })}
          />
        </div>
      </div>
      <div className="about-container-4 py-6">
          ...
          {section5?.data?.map((item, index) => (
            <div key={index} className="container-4-item">
              ...
              <input
                ...
                onChange={e => handleImageUploadSection5(e, "title", index)}
              />
              <textarea
      ...
      <div className="about-container-5 py-6">
        <div className="container-5-item">
          <input
            type="text"
            defaultValue={section6?.title}
            onChange={e =>
              setSection6({ ...section6, title: e?.target?.value })
            }
          />

          <ReactQuill
            defaultValue={section6?.desc}
            onChange={e => setSection6({ ...section6, desc: e })}
          />
          {section6?.data?.map((item, index) => (
            <div key={index} className="container-5-item py-6">
              <img
                alt="hair"
                src={item?.icon}
              ...
              <input
                type="text"
                defaultValue={item?.title}
                onChange={e => handleImageUploadSection6(e, "title", index)}
              />
              <textarea
                defaultValue={item?.desc}
                onChange={e => handleImageUploadSection6(e, "desc", index)}
              />
            </div>
          ))}
        </div>
