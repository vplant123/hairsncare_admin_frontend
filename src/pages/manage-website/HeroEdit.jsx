...
export default function HeroEdit({ section1, setSection1 }) {
  const navigate = useNavigate();
  const [selectedHero, setSelectedHero] = useState(1);
  const [data, setData] = useState([]);
  const [hairTestButtonText, setHairTestButtonText] =
    useState("TAKE HAIR TEST");
  const [bookAppointmentButtonText, setBookAppointmentButtonText] = useState(
    "BOOK AN APPOINTMENT"
  );
                    ...
                    <div className="hero-content">
                      ...
                      <div className="Edit-Image">
                        ...
                        <input
                          ...
                          accept="image/*"
                          onChange={e =>
                            handlesetDataChange(e.target.files[0], ind, "image")
                          }
                        />
                        <img
