...
import "../core-principle-section/CorePrinciple.css";

function CoreEdit({ section6, setSection6 }) {
  ...
  return (
    <div className="core-wrapper ">
      <hr />
      <div className="core row d-flex">
        {/* <h1>{section6?.mainDes}</h1> */}
        <input
          type="text"
          defaultValue={section6?.mainDes}
          onChange={e =>
            setSection6({ ...section6, mainDes: e?.target?.value })
          }
          className="editable-input"
          // style={{width : "75px"}}
        />
        <div className="core-image d-flex">
