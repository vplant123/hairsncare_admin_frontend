...
function HairTransplant({
  ...
  const [section2Forms, setSection2Forms] = useState([{ title: "" }]);
  const [section3Forms, setSection3Forms] = useState([{ title: "", desc: "" }]);
  const [section4Forms, setSection4Forms] = useState([{ title: "", desc: "" }]);
  const [section5Forms, setSection5Forms] = useState([{ title: "", desc: "" }]);
  const [section6Forms, setSection6Forms] = useState([
    { title: "", desc: "", image: "" },
  ]);
  ...
  useEffect(() => {
    if (section6?.forms) {
      setSection6Forms(section6.forms);
    }
  }, [section6?.forms]);
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <ReactQuill
              ...
              onChange={(e) =>
                handleSectionChange1("footerText", setSection3, e)
              }
            />
          </div>
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <ReactQuill
              ...
              onChange={(e) =>
                handleSectionChange1("footerText", setSection4, e)
              }
            />
          </div>
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <ReactQuill
              ...
              onChange={(e) =>
                handleSectionChange1("footerText", setSection5, e)
              }
            />
          </div>
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <ReactQuill
              ...
              onChange={(e) =>
                handleSectionChange1("footerText", setSection6, e)
              }
            />
          </div>
          {section6Forms.map((form, index) => (
            <div
              key={index}
              style={{
                border: "1px solid #ccc",
          ...
          <button
            onClick={() => addForm(setSection6Forms, section6Forms)}
            style={{ marginTop: "10px" }}
          >
            Add Form
          </button>
