...
import HairLossWomen from "./manage-website/HairLossWomen";
import HairLossMen from "./manage-website/HairLossMen";
import HairTransplant from "./manage-website/HairTransplant";
import OtherProcedures from "./manage-website/OtherProcedures";
import OnlineTest from "./manage-website/OnlineTest";
import Dermatologist from "./manage-website/Dermatologist";
...
function ManageWebsite() {
              ...
              ? content?.specialist?._id : selectedTab === "Our Expertise Page"
                ? content?.expertise?._id : selectedTab === "Happy Customer"
                  ? content?.customerVideos?._id : selectedTab === "Contact Us"
                    ? content?.contactus?._id : selectedTab === "Hair Loss In Women"
                      ? content?.hairWomen?._id : selectedTab === "Hair Loss In Men"
                        ? content?.hairMen?._id : selectedTab === "Hair Transplant"
                          ? content?.hairTransplant?._id : selectedTab === "Other Procedures"
                            ? content?.otherProcedures?._id : selectedTab === "Online Test"
                              ? content?.onlineTest?._id : selectedTab === "Dermatologist"
  ...
  return (
    <AdminNavbar>
      <div className="test-link container">
        <div className="test-link-item">
          ...
          <div
            ...
            className={`tab-2 tab tab2 ${selectedTab === "Our Expertise Page" ? "selected1" : ""
              }`}
          >
            Our Expertise Page
          </div>
          ...
          <div
            ...
            className={`tab-2 tab tab2 ${selectedTab === "Hair Loss In Women" ? "selected1" : ""
              }`}
          >
            Hair Loss In Women
          </div>
          ...
          <div
            ...
            className={`tab-2 tab tab2 ${selectedTab === "Hair Loss In Men" ? "selected1" : ""
              }`}
          >
            Hair Loss In Men
          </div>
          ...
          <div
            ...
            className={`tab-2 tab tab2 ${selectedTab === "Hair Transplant" ? "selected1" : ""
              }`}
          >
            Hair Transplant
          </div>
          ...
          <div
            ...
            className={`tab-2 tab tab2 ${selectedTab === "Other Procedures" ? "selected1" : ""
              }`}
          >
            Other Procedures
          </div>
          ...
          <div
            ...
            className={`tab-2 tab tab2 ${selectedTab === "Online Test" ? "selected1" : ""
              }`}
          >
            Online Test
          </div>
          ...
          <div
            ...
            className={`tab-2 tab tab2 ${selectedTab === "Dermatologist" ? "selected1" : ""
              }`}
          >
            Dermatologist
          </div>
      ...
      {selectedTab === "Hair Loss In Women" && <HairLossWomen section1={section1} setSection1={setSection1} section2={section2} setSection2={setSection2} section3={section3} setSection3={setSection3} section4={section4} setSection4={setSection4} section5={section5} setSection5={setSection5} section6={section6} setSection6={setSection6} section7={section7} setSection7={setSection7} />}
      {selectedTab === "Hair Loss In Men" && <HairLossMen section1={section1} setSection1={setSection1} section2={section2} setSection2={setSection2} section3={section3} setSection3={setSection3} section4={section4} setSection4={setSection4} section5={section5} setSection5={setSection5} />}
      {selectedTab === "Hair Transplant" && <HairTransplant section1={section1} setSection1={setSection1} section2={section2} setSection2={setSection2} section3={section3} setSection3={setSection3} section4={section4} setSection4={setSection4} section5={section5} setSection5={setSection5} section6={section6} setSection6={setSection6} section7={section7} setSection7={setSection7} />}
      {selectedTab === "Other Procedures" && <OtherProcedures section1={section1} setSection1={setSection1} section2={section2} setSection2={setSection2} section3={section3} setSection3={setSection3} section4={section4} setSection4={setSection4} section5={section5} setSection5={setSection5} />}
      {selectedTab === "Online Test" && <OnlineTest section1={section1} setSection1={setSection1} section2={section2} setSection2={setSection2} section3={section3} setSection3={setSection3} section4={section4} setSection4={setSection4} section5={section5} setSection5={setSection5} />}
      {selectedTab === "Dermatologist" && <Dermatologist section1={section1} setSection1={setSection1} section2={section2} setSection2={setSection2} section3={section3} setSection3={setSection3} section4={section4} setSection4={setSection4} section5={section5} setSection5={setSection5} section6={section6} setSection6={setSection6} section7={section7} setSection7={setSection7} section8={section8} setSection8={setSection8} />}
      {selectedTab === "Hair-test-price" && <ManagePrice content={content.plan} content1={content.config} />}
      {
