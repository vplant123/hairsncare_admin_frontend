    ...
    <div className="" style={{ padding: "0 20px", pageBreakBefore: "avoid" }}>
      <div className="" style={{ padding: "20px" }}>
        ...
        <div className="d-flex" style={{ gap: "6%" }}>
          <div
            className={`${styles.headManagerReportPage1Sec1} d-flex flex-column mt-5`}
            style={{ gap: "12px" }}
          >
            <div
              className={styles.headManagerReportPage1Sec1Left}
          ...
          <div
            className={`${styles.headManagerReportPage1Sec1} d-flex flex-column`}
            style={{ justifyContent: "space-between", position: "relative" }}
          >
            <div
              style={{ width: "100%", display: "flex", justifyContent: "end" }}
            >
              <div className={styles.headManagerReportPage1Sec1RightTop}>
                {data?.personal?.name}
              </div>
            </div>

            <div
              className={`${styles.headManagerReportPage1Sec1RightBottom} d-flex flex-column`}
            >
              <div
                className={styles.headManagerReportPage1Sec1RightBottomText1}
              >
                Dr Amit Agarkar
              </div>
              <div
                className={styles.headManagerReportPage1Sec1RightBottomText2}
              >
                MBBS, MD, FCPS,DDV
              </div>
              <div
        ...
        <div className="d-flex mt-5" style={{ gap: "5%" }}>
          <div className="d-flex flex-column" style={{ width: "50%" }}>
            ...
            <div style={{ fontSize: "28px" }}>
              YOUR{" "}
              <span style={{ color: "rgba(0, 160, 227, 1)" }}>
                HAIR EXPERT!
              </span>
            </div>
            <div style={{ fontSize: "12px" }}>
              Dear {data?.personal?.sex == "Male" ? "Mr" : "Miss"}.{" "}
              {data?.personal?.name}, We appreciate your interest in taking part
              in this detailed hair assessment. Your willingness to participate
              will greatly contribute to our research and understanding of the
              subject matter. Thank you for your time and effort in completing
              this test. We assure you that your responses will be treated with
              utmost confidentiality and will be utilized solely for research
              purposes. Your contribution is immensely valuable, and we are
              grateful for your cooperation. Your involvement plays a pivotal
              role in the success of hair growth journey
            </div>
          </div>
          <div className={`row ${styles.sec2Right}`} style={{ width: "45%" }}>
            <div
        ...
        <div className="" style={{ marginTop: "70px" }}>
          <div className={styles.sec3Pos1} style={{ position: "relative" }}>
            <div className="row" style={{ padding: 0 }}>
              <div
                className="col-3"
                style={{ padding: "0 40px", position: "relative" }}
              >
                <div
                  className={styles.sec3Pos2}
                  style={{
                    position: "absolute",
                    top: "-15px",
                    width: "100%",
          ...
          <div className="row">
            <div className="col-4" style={{ padding: "0 30px" }}>
              <div className={`${styles.sec4Main} row`}>
                <div
                  className="col-4"
        ...
        >
          ...
          Nevertheless, it is imperative to accentuate that the precision of
          this diagnosis may exhibit incongruities across individuals. Various
