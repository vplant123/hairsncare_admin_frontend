...
export default function Page3({ data }) {
  ...
  return (
    <div className="page-avoid-1" style={{ padding: "10px" }}>
      <div
        className={`${styles.headManagerReport} d-flex`}
        style={{ justifyContent: "space-between" }}
      >
        <img
          src="/assets/img/logo.png"
          className={styles.headManagerReportLogo}
        />
        <div className={styles.headManagerReportText1}>
          Doctors Analysis Report
        </div>
        <div
          className={styles.textFlexLineCenterVertical}
      ...
      >
        <div
          className={styles.page2Sec1Main}
          style={{
            fontSize: "16px",
            fontWeight: "600",
            background: "rgba(2, 161, 229, 1)",
          }}
        >
          Diagnosis
        </div>
        ...
        >
          {data?.dianosis?.map(item => {
            return (
              <>
                <div
                  className={`${styles.page3Sec3} d-flex`}
                  style={{
                    padding: "10px",
                    width: "90%",
                    gap: "8px",
                ...
                >
                  <div className={styles.page3Sec3Sec1}></div>
      ...
      >
        <div style={{ width: "70%", fontSize: "10px", textAlign: "center" }}>
          Identifying the cause of hair loss through diagnosis ensures precise
          treatments, minimizes ineffective solutions, and uncovers potential
          health concerns. This approach enhances both treatment success and
          overall well-being.
        </div>
      </div>
      ...
      >
        <div style={{ width: "50%", fontSize: "10px", textAlign: "center" }}>
          For further information for your condition click on the
          diagnosis.{" "}
        </div>
      </div>
      ...
      >
        <div style={{ width: "70%", fontSize: "10px", textAlign: "center" }}>
          This report evaluates your hair health to identify concerns and
          provide recommendations, analyzing hair quality, scalp condition,
          density, color, breakage, and hydration based on your online test
          data.{" "}
        </div>
      </div>
    ...
    <div className="" style={{
      ...
      >
        <div
          ...
          className={styles.manPage3ColorMain}
        >
          <div style={{ width: "35%" }}>
            <img
              src="/assets/img/reports/doctorAnalysis/page3/image.png"
              style={{ width: "100%", height: "100%" }}
            />
          </div>
          <div
            className={styles.manPage3ColorText}
            style={{
              position: "absolute",
              left: "8%",
              top: "7%",
              background: data?.overall?.["ExaminationColor"] || "#28EB28",
            }}
          >
            <div
              style={{
            ...
            >
              ...
              >
                <img
                  src="/assets/img/reports/doctorAnalysis/page3/isolationmode1258-injk.svg"
                  style={{ width: "100%", height: "100%" }}
                />
              </div>
            </div>
            <div className={styles.manPage3ColorTextSec}>Scalp Examination</div>
          </div>
          ...
          <div
            ...
            style={{
              ...
              left: "4%",
              top: "33%",
              background: data?.overall?.["DensityColor"] || "#28EB28",
            }}
          >
            <div
              style={{
            ...
            >
              ...
              >
                <img
                  src="/assets/img/reports/doctorAnalysis/page3/objects1279-291a.svg"
                  style={{ width: "100%", height: "100%" }}
                />
              </div>
            </div>
            <div className={styles.manPage3ColorTextSec}>Hair Density</div>
          </div>
          ...
          <div
            ...
            style={{
              ...
              left: "8%",
              bottom: "24%",
              background: data?.overall?.["MoistureColor"] || "#28EB28",
            }}
          >
            <div
              style={{
            ...
            >
              ...
              >
                <img
                  src="/assets/img/reports/doctorAnalysis/page3/objects1299-bec2.svg"
                  style={{ width: "100%", height: "100%" }}
                />
              </div>
            </div>
            <div className={styles.manPage3ColorTextSec}>
          ...
          <div
            ...
            style={{
              ...
              right: "8%",
              bottom: "24%",
              background: data?.overall?.["breakageColor"] || "#28EB28",
            }}
          >
            <div
              style={{
            ...
            >
              ...
              >
                <img
                  src="/assets/img/reports/doctorAnalysis/page3/isolationmode1287-w6ih.svg"
                  style={{ width: "100%", height: "100%" }}
                />
              </div>
            </div>
            <div className={styles.manPage3ColorTextSec}>Hair Breakage</div>
          </div>
          ...
          <div
            ...
            style={{
              ...
              right: "4%",
              top: "33%",
              background: data?.overall?.["vibrancy"] || "#28EB28",
            }}
          >
            <div
              style={{
            ...
            >
              ...
              >
                <img
                  src="/assets/img/reports/doctorAnalysis/page3/isolationmode1292-uqpj.svg"
                  style={{ width: "100%", height: "100%" }}
                />
              </div>
            </div>
            <div className={styles.manPage3ColorTextSec}>Color Vibrancy</div>
          </div>
          ...
          <div
            ...
            style={{
              ...
              right: "8%",
              top: "7%",
              background: data?.overall?.["qualityColor"] || "#28EB28",
            }}
          >
            <div
              style={{
            ...
            >
              ...
              >
                <img
                  src="/assets/img/reports/doctorAnalysis/page3/objects1294-96jg.svg"
                  style={{ width: "100%", height: "100%" }}
                />
              </div>
            </div>
      ...
      <div
        className="d-flex page-break-2"
        style={{ gap: "5%", marginTop: "1%" }}
      >
        <div style={{ width: "50%" }}>
          <img
            src="/assets/img/reports/doctorAnalysis/page3/Screenshot 2024-11-15 at 12.50.37 AM.png"
            style={{ width: "100%", height: "100%" }}
          />
        </div>

        <div style={{ width: "45%", gap: "5%" }} className="d-flex flex-column">
          <div style={{ fontSize: "18px", fontWeight: "700" }}>Conclusion</div>
          <div style={{ fontSize: "12px", fontWeight: "600" }}>
            Your Overall hair health is deemed to be
          </div>
          <div
            className="page-3-sec-4"
            style={{
              display: "flex",
              justifyContent: "center",
              alignItems: "center",
