...
function MediaEdit({ section5, setSection5 }) {
  ...
  return (
    <>
      <div
        className="media-content row d-flex "
        style={{
          fontFamily: '"Poppins", sans-serif',
        }}
      >
        <div
          className="m-c animate__backInLeft animate__animated"
        ...
        <div
          className="Media-feature animate__animated animate__fadeInRight"
          style={{ animationDelay: "1s" }}
        >
