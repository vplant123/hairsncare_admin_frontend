...
import "../book-appointment/BookAppointment.css";
    ...
    try {
      ...
      try {
        const response = await fetch(
          `${BASE_URL}/users/bookAppointmentContactUs`,
          {
            method: "POST",
            headers: {
      ...
      <div className="contact-section-two pt-70 pb-0">
        ...
        >
          ...
          <div
            ...
            style={{
              background: `url("/assets/img/info-bg.jpg") center top no-repeat`,
        ...
        <div className="d-flex flex-column">
          ...
          <div className="d-flex flex-column">
            <img
              ...
              style={{ height: "100%", width: "100%" }}
            />
            <input type="file" onChange={e => handleImageUploadSection3(e)} />
          </div>
